...
public class SonicDirectorBlock extends Block implements ISonicStone {
    ...
    public SonicDirectorBlock(Properties properties) {
        super(properties);
    ...
    public void Signal(SonicStoneInteraction interaction) {
        ...
        ISonicStone.CreateSignal(interaction.world, interaction.blockPos, state.getValue(BOOST) ? interaction.sourceStrength : interaction.strength, state.getValue(FACING));
